...
public class Forms extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
         ...
         * number.
         */
        public static PlaceholderFragment newInstance(String form) {
            PlaceholderFragment fragment = new PlaceholderFragment();
            Bundle args = new Bundle();
            args.putString(FORM_NAME, form);
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            textView.setText(getArguments().getCharSequence(FORM_NAME));
            return rootView;
        }
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
             if(position == 0)
                 return PlaceholderFragment.newInstance("CTC Form");
            else if(position == 1)
                 return PlaceholderFragment.newInstance("Non CTC Form");
            else return null;
        }
